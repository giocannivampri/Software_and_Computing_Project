...
In the **Project folder** one can find the codes and output files:
 ...
 2. *_ initmap _.py*: Module containing the classes, with various useful methods to monitor the simulation, including the one that calculate the current of particles loss.
