...
In this way, fixing r_1 equal to 5 U+03C3, we are left with only around 10^4 particles to iterate 10^5 times. It is still a large amount of computation to make.
...
The runtime of the simulation of 10^6 total initial particles (around 1.4*10^4 halo particles, fixing r_1 equal to 5 sigma) for 10^3 iterations is around 198 seconds, while using Numba it is around 1.4 senconds, which gives a **speed up** of around 141.4.
